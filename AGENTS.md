...
33. Deterministic local `chart.html` artifacts for round inspection, generated without visual agents or network calls.
...
`analysis_notes.md`, `chart.html`, `visual_review.json`, `visual_review.md`,
...
the read-only visual review stub's consumed `chart.html`, consumed before-trade
