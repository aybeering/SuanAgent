...
read-only authority, policy flags, selected-candidate count,
candidate-quality source-path binding, candidate-quality selected-count
binding, candidate/selectable/selected count bounds, plus research-watchlist
status and alert count bindings. The command
