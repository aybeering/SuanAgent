...
round-table, and proposal-quality sections against the corresponding manifest
records and round artifacts, so operator-facing data split, outcome, per-round,
proposal-quality, and agent-output diagnosis fields stay tied to the
