...
health, codex-cli-unlock-runbook, config-operator-runbook,
operator-action-dashboard, operator-cockpit, operator-home,
operator-next-command, operator-unlock-checklist, round-table, proposal-quality,
and candidate-leaderboard sections against the corresponding
