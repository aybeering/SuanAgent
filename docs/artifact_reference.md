...
commit. It also checks the `summary.md` dataset, run-outcome, and agent-intake
sections against the corresponding manifest records, so operator-facing data
split, outcome, and agent-output diagnosis fields stay tied to the
