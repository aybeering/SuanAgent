...
primary focus, blocker count, primary blocker, blocker preview, before/after
blocker delta counts, and first recommended next command with its reason, plus
a compact safety-policy summary.
